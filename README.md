...
> Last updated: 2026-04-18T05:25:49Z
...
xychart-beta horizontal
    ...
    x-axis ["mcp-stdio", "github-insights", "junos-mcp", "aruba-central-mcp", "keycloak-mcp", "gws-mcp", "junos-ops", "homebrew-tap"]
    y-axis "Views"
    bar [330, 171, 121, 117, 115, 114, 104, 98]
```
...
xychart-beta horizontal
    ...
    y-axis "Views"
    bar [19, 7, 6, 45, 43, 39, 10, 170, 136, 53, 17, 55, 89, 70, 40, 139, 144, 99, 40, 43, 8, 0]
```
...
xychart-beta horizontal
    ...
    y-axis "Clones"
    bar [1094, 788, 594, 532, 514, 429, 317, 311]
```
