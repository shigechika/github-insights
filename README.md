...
> Last updated: 2026-08-26T08:21:28Z

### Views by Repository

```mermaid
xychart-beta horizontal
    title "Views by Repository (163 days)"
    x-axis ["jquants-mcp", "mcp-stdio", "junos-ops", "gws-mcp", "github-insights", "keycloak-mcp", "junos-mcp", "eos-mcp"]
    y-axis "Views"
    bar [2043, 1693, 749, 620, 542, 350, 289, 286]
```
...
xychart-beta horizontal
    ...
    x-axis ["07-28", "07-29", "07-30", "07-31", "08-01", "08-02", "08-03", "08-04", "08-05", "08-06", "08-07", "08-08", "08-09", "08-10", "08-11", "08-12", "08-13", "08-14", "08-15", "08-16", "08-17", "08-18", "08-19", "08-20", "08-21", "08-22", "08-23", "08-24", "08-25", "08-26"]
    y-axis "Views"
    bar [12, 57, 19, 78, 55, 57, 17, 10, 10, 125, 69, 119, 102, 123, 189, 21, 31, 71, 38, 9, 54, 23, 32, 53, 17, 89, 72, 40, 9, 0]
```
