...
> Last updated: 2026-07-09T21:05:47Z

### Views by Repository

```mermaid
xychart-beta horizontal
    title "Views by Repository (115 days)"
    x-axis ["jquants-mcp", "mcp-stdio", "junos-ops", "gws-mcp", "github-insights", "junos-mcp", "eos-mcp", "keycloak-mcp"]
    y-axis "Views"
    bar [1621, 894, 605, 554, 485, 222, 216, 210]
```
...
xychart-beta horizontal
    ...
    y-axis "Views"
    bar [9, 10, 5, 9, 14, 6, 78, 18, 44, 2, 4, 4, 12, 5, 21, 14, 34, 20, 27, 25, 44, 8, 50, 74, 9, 121, 76, 72, 148, 0]
```
