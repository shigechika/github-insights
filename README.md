...
> Last updated: 2026-08-03T20:46:31Z

### Views by Repository

```mermaid
xychart-beta horizontal
    title "Views by Repository (139 days)"
    x-axis ["jquants-mcp", "mcp-stdio", "junos-ops", "gws-mcp", "github-insights", "keycloak-mcp", "eos-mcp", "junos-mcp"]
    y-axis "Views"
    bar [1847, 1324, 696, 577, 534, 281, 280, 279]
```
...
xychart-beta horizontal
    ...
    x-axis ["07-04", "07-05", "07-06", "07-07", "07-08", "07-09", "07-10", "07-11", "07-12", "07-13", "07-14", "07-15", "07-16", "07-17", "07-18", "07-19", "07-20", "07-21", "07-22", "07-23", "07-24", "07-25", "07-26", "07-27", "07-28", "07-29", "07-30", "07-31", "08-01", "08-02"]
    y-axis "Views"
    bar [9, 121, 76, 72, 148, 24, 145, 22, 249, 30, 31, 14, 25, 74, 66, 25, 24, 18, 45, 54, 261, 43, 33, 13, 12, 57, 19, 78, 55, 0]
```
